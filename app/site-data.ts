...
export const categories: Category[] = [
  ...
  },
  {
    ...
    title: "Dryer Filters & Lint Screens",
    kicker: "Dryer replacement filtration",
    description: "Wholesale dryer lint filters, screens and filter assemblies organized by replacement reference, frame profile and compatible appliance model.",
    matching: "Part number · complete dryer model · frame profile · guide version",
    shape: "screen",
    ...
    subcategories: ["Dryer Lint Screens", "Dryer Filter Assemblies"],
    compatibleBrands: [
    ...
    brandNote: "The first published release covers verified lint-filter families for LG, Kenmore, Whirlpool, Maytag, GE, Hotpoint, Samsung, Frigidaire and related dryer models. Final fit is checked by the complete machine model and filter-guide configuration.",
    referenceExamples: ["Dryer brand", "Machine model", "Replacement part number", "Frame shape and size"],
    fitChecks: ["Part and cross-reference numbers", "Complete dryer model suffix", "Frame and guide profile", "Handle, flap and mesh details"],
  },
];
