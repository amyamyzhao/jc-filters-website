...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Ready-stock dispatch support, FBA service and custom packaging for replacement-filter sellers.',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'JC Filters | Replacement filtration, ready for replenishment',
    description: 'A replacement-filter catalog framework for global sellers.',
