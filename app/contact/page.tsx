      ...
      <section className="contact-page">
        <div className="shell contact-page-grid">
          ...
          <div className="contact-panel">
            <span className="panel-label">PREFERRED</span>
            <h2>WhatsApp</h2><p>Fastest for part photos, lists and continuing discussion.</p>
            <a className="btn" href={whatsappLink("Hello JC Filters, I would like to start a replacement-filter inquiry.")} target="_blank" rel="noopener noreferrer">Chat on WhatsApp <span>↗</span></a>
